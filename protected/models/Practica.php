...
class Practica extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('CAR_CODIGO, PER_ID, PRA_ESTPRACTICA, PRA_ESTF1, PRA_ESTF3, PRA_ESTINFORME, PRA_DESCRIPCION, PRA_INICIO, PRA_TERMINO, PRA_TIPO', 'required'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'PRA_DESCRIPCION' => 'Pra Descripcion',
			'PRA_INICIO' => 'Pra Inicio',
			'PRA_TERMINO' => 'Pra Termino',
			'PRA_TIPO' => 'Pra Tipo',
		);
	}
