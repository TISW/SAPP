	...
	<div class="row">
		<div class="col-xs-12 col-sm-2 col-md-2">
			<ul class="nav nav-pills nav-stacked" style="max-width: 300px;">
				...
				<li><a href="<?php echo Yii::app()->createUrl('Alumnos/IngresarBitacora'); ?>">Igresar Bitácoras</a></li>
				<li><a href="<?php echo Yii::app()->createUrl('Alumnos/MostrarBitacora'); ?>">Mostrar Bitácora</a></li>
				<li><a href="<?php echo Yii::app()->createUrl('Alumnos/MostrarBitacoras'); ?>">Mostrar Bitácoras</a></li>
			</ul>
		</div>
